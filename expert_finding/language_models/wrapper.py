...
def build_all(texts, output_dir, min_count=3, cpu_workers=16, window_size=10, filter_min=20, filter_max=400):
    ...
    # expert_finding.data.io.save_as_json(output_dir_temp, config["texts_filename"], texts)
    expert_finding.data.io.save_as_json(output_dir_temp, "texts.json", texts)
    ...
    # expert_finding.data.io.save_as_json(output_dir_temp, config["length_filter_filename"],
    #                                                  corpus_length_filter)
    # "length_filter.json"
    expert_finding.data.io.save_as_json(output_dir_temp, "length_filter.json", corpus_length_filter)
    ...
    # expert_finding.data.io.save_as_json(output_dir_temp, config["stamp_filename"], stamp)
    expert_finding.data.io.save_as_json(output_dir_temp, "stamp.json", stamp)
